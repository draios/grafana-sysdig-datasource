    ...
    stages {
        ...
        stage('Deploy') {
            environment {
                ...
                BUILD_FILE_NAME = "$FILE_NAME_PREFIX-$VERSION.$BUILD_NUMBER"
            ...
            steps {
                ...
                echo 'aws s3 cp $BUILD_FILE_NAME.tgz s3://download.draios.com/stable/grafana-sysdig-datasource/$RELEASE_NAME_PREFIX.tgz --acl public-read'
            }
        }
    }
}